...
"font-family: Noto Sans;")
        ...
        self.actionClear_scan_resullt_for_file = QAction(MainWindow)
        self.actionClear_scan_resullt_for_file.setObjectName(u"actionClear_scan_resullt_for_file")
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/bl_img/icons/folder_open_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/bl_img/icons/upgrade_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.exportButton.setIcon(icon2)
        self.exportButton.setIconSize(QSize(20, 35))
        self.exportButton.setAutoRaise(False)

        self.gridLayout.addWidget(self.exportButton, 15, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.playButton, 5, 0, 1, 1)
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/bl_img/icons/playlist_play_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.queueButton.setIcon(icon4)
        self.queueButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.queueButton, 9, 0, 1, 1)
...
"}")
        icon5 = QIcon()
        icon5.addFile(u":/bl_img/icons/widgets_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.gridLayout.addWidget(self.switchModeButton, 16, 0, 1, 1)
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/bl_img/icons/music_video_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.slncDtctButton.setIcon(icon6)
        self.slncDtctButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.slncDtctButton, 11, 0, 1, 1)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u":/bl_img/icons/remove_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.delButton.setIcon(icon7)
        self.delButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.delButton, 4, 0, 1, 1)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u":/bl_img/icons/menu_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.switchToolButton.setIcon(icon8)
        ...
        self.gridLayout.addWidget(self.switchToolButton, 0, 0, 1, 1)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u":/bl_img/icons/add_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon10 = QIcon()
        icon10.addFile(u":/bl_img/icons/call_to_action_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.blckDtctButton.setIcon(icon10)
        self.blckDtctButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.blckDtctButton, 10, 0, 1, 1)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u":/bl_img/icons/settings_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.settingsButton.setIcon(icon11)
        self.settingsButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.settingsButton, 18, 0, 1, 1)
...
"}")
        icon12 = QIcon()
        icon12.addFile(u":/bl_img/icons/equalizer_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.r128DtctButton.setIcon(icon12)
        self.r128DtctButton.setIconSize(QSize(20, 35))

        self.gridLayout.addWidget(self.r128DtctButton, 8, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.frzDtctButton, 12, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.fullDtctButton, 13, 0, 1, 1)
        ...
        self.tableView_db = QTableView(self.layoutWidget)
...
"}")
        ...
        icon15 = QIcon()
        icon15.addFile(u":/bl_img/icons/expand_more_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.resizeButtonDown.setIcon(icon15)
...
"margin: 4px;")
        ...
        icon16 = QIcon()
        icon16.addFile(u":/bl_img/icons/expand_less_FILL0_wght400_GRAD0_opsz24.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.resizeButtonUp.setIcon(icon16)
...
"}")
        ...
        self.menuDataBase.addAction(self.actionClear_scan_resullt_for_file)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionClear_scan_resullt_for_file.setText(QCoreApplication.translate("MainWindow", u"Clear scan resullt for file...", None))
